...
class EventoController extends Controller
{
    ...
    public function index()
    {
        ...
        $opiniones = DB::select("select comentarioeventos.* ,users.name  from comentarioeventos inner JOIN
        users on comentarioeventos.idUsuarioComentario = users.id order by comentarioeventos.created_at desc");
            return view('eventos.eventos',  ['eventos' => $eventos, 'opiniones' => $opiniones]);
