...
@section('contenido')
    ...
    <body>
      ...
      <div class="d-block mx-auto text-center">
        ...
        <a href="{{ route('lugares') }}" class="btn btn-secondary mt-2 ">Volver</a>
      </div>
      ...
      <div class="container bg-white mt-5 ">
        ...
        <div class="mb-5 pb-5">
          ...
          <h1 class="text-center fw-bold text-decoration-underline">Lugares</h1>
            ...
            <iframe class="d-block mx-auto rounded-3  border border-dark " width="600" height="400" src="{{$lugar->ubicacion}} " frameborder="0"></iframe>
          </div>
